...
import { Dumbbell, Mail, Lock, AlertCircle, CheckCircle, Zap, ArrowRight, Loader2 } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="flex flex-wrap gap-1.5 justify-center mb-6">
          {[
            ...
            <span
              key={label}
              className="px-2.5 py-0.5 rounded-full bg-slate-800 border border-slate-700/80 text-slate-300 text-[11px] font-medium"
            >
              {label}
            </span>
          ))}
